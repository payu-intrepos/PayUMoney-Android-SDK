...
public class PagerSlidingTabStripCustomised extends HorizontalScrollView {
    ...
    private int transparentColorId = R.color.white;
    ...
    public PagerSlidingTabStripCustomised(Context context) {
        this(context, null);
    }

    public PagerSlidingTabStripCustomised(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingTabStripCustomised(Context context, AttributeSet attrs, int defStyle) {
